...
class QuantumSimulation(models.Model):
    ...
    quantum_advantage_factor = models.FloatField(null=True, blank=True, 
        help_text="Speed improvement vs classical computing")
    coherence_time_used = models.FloatField(null=True, blank=True, help_text="Quantum coherence time in microseconds")
    error_rate = models.FloatField(null=True, blank=True, help_text="Quantum error rate")
