...
from .models import (
    ...
    SequenceActivity, ABTest, AutomatedTrigger, SequenceAnalytics
)
...
class SequenceExecutionService:
    ...
    def _select_email_variant(self, step: SequenceStep) -> Optional[SequenceEmail]:
        """Select email variant for A/B testing"""
    ...
    def _should_exit(self, enrollment: SequenceEnrollment) -> bool:
        ...
        if exit_conditions.get('on_reply'):
            if enrollment.emails_replied > 0:
                return True
