...
from .serializers import (
    ConsentTypeSerializer, UserConsentSerializer, UserConsentListSerializer,
    DataExportRequestSerializer, DataDeletionRequestSerializer,
    DataProcessingActivitySerializer, DataBreachIncidentSerializer,
    DataBreachIncidentListSerializer, DataAccessLogSerializer,
    PrivacyNoticeSerializer, UserPrivacyPreferenceSerializer
)
...
class UserPrivacyPreferenceViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'])
    def accept_notice(self, request, pk=None):
