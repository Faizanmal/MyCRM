...
from .models import Opportunity, OpportunityStage, OpportunityActivity, Product, OpportunityProduct
from .serializers import (
    OpportunitySerializer, OpportunityCreateSerializer, OpportunityStageSerializer,
    OpportunityActivitySerializer, ProductSerializer, OpportunityProductSerializer,
