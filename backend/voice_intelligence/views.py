...
from .serializers import (
    ...
    BulkActionItemUpdateSerializer,
    CallScoreSerializer,
    ConversationCategorySerializer,
    ConversationSummarySerializer,
    KeyMomentSerializer,
    ProcessRecordingSerializer,
    SearchRecordingsSerializer,
    TranscriptionEditSerializer,
    TranscriptionSerializer,
    TranscriptionSettingsSerializer,
    VoiceNoteCreateSerializer,
    VoiceNoteSerializer,
    VoiceRecordingCreateSerializer,
    VoiceRecordingDetailSerializer,
    VoiceRecordingListSerializer,
)
...
class VoiceRecordingViewSet(viewsets.ModelViewSet):
    ...
    def process(self, request, __pk=None):
    ...
    @action(detail=True, methods=['post'])
    def transcribe(self, _request, _pk=None):
    ...
    @action(detail=True, methods=['post'])
    def analyze(self, request, _pk=None):
    ...
    def transcription(self, request, _pk=None):
    ...
    def edit_transcription(self, request, _pk=None):
    ...
    @action(detail=True, methods=['get'])
    def summaries(self, request, _pk=None):
    ...
    @action(detail=True, methods=['post'])
    def generate_summary(self, request, _pk=None):
    ...
    @action(detail=True, methods=['get'])
    def action_items(self, request, _pk=None):
    ...
    @action(detail=True, methods=['get'])
    def key_moments(self, request, _pk=None):
    ...
    @action(detail=True, methods=['post'])
    def add_key_moment(self, request, _pk=None):
    ...
    @action(detail=True, methods=['get'])
    def call_score(self, request, _pk=None):
    ...
    @action(detail=True, methods=['post'])
    def categorize(self, request, _pk=None):
...
class ActionItemViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'])
    def confirm(self, request, _pk=None):
    ...
    @action(detail=True, methods=['post'])
    def create_task(self, request, _pk=None):
