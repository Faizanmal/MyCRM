...
def generate_summary_task(recording_id: str, summary_type: str = 'executive'):
    ...
    try:
        from .models import VoiceRecording, ConversationSummary
...
def extract_action_items_task(recording_id: str):
    ...
    try:
        from .models import VoiceRecording, ActionItem
...
def score_call_task(recording_id: str):
    """Score a sales call"""
    try:
        from .models import VoiceRecording, CallScore
...
def generate_daily_analytics():
    ...
    from .models import VoiceRecording, CallScore, ActionItem
