...
class MultiChannelCampaignService:
    ...
    def add_campaign_step(
        ...
        from .enhanced_models import MultiChannelCampaign, CampaignStep
    ...
    def start_campaign(self, campaign_id: str) -> Dict[str, Any]:
        """Start a campaign"""
        from .enhanced_models import MultiChannelCampaign, CampaignRecipient
    ...
    def get_campaign_analytics(
        ...
        from .enhanced_models import MultiChannelCampaign, CampaignStep, CampaignRecipient
...
class EmailTrackingService:
    ...
    def create_tracking(
        ...
        tracking = AdvancedEmailTracking.objects.create(
            user=self.user,
