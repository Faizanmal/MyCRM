...
class DocumentViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'])
    def send(self, request, _pk=None):
    ...
    @action(detail=True, methods=['post'])
    def void(self, request, _pk=None):
        """Void a document"""
        document = self.get_object()
    ...
    @action(detail=True, methods=['post'])
    def remind(self, request, _pk=None):
    ...
    def audit_log(self, request, _pk=None):
