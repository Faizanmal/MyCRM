...
from .routing_engine import AILeadRouter, LeadRebalancer, RoundRobinRouter
...
class LeadRoutingService:
    ...
    def route_lead(
        ...
        force_rule: RoutingRule | None = None
    ) -> tuple[LeadAssignment | None, dict[str, Any]]:
        """
        ...
        rule = force_rule if force_rule else self._find_matching_rule(lead_data)
    ...
    def _find_matching_rule(self, lead_data: dict) -> RoutingRule | None:
    ...
    def _get_available_reps(self, rule: RoutingRule | None = None) -> list[SalesRepProfile]:
    ...
    def _update_rep_counts(self, old_assignee: User | None, new_assignee: User):
