...
from .serializers import (
    ...
    ChannelSerializer,
    CollaborativeDocumentSerializer,
    DealRoomListSerializer,
    DealRoomParticipantSerializer,
    DealRoomSerializer,
...
class DealRoomViewSet(viewsets.ModelViewSet):
    ...
    def join(self, request, _pk=None):
        """Join a deal room."""
    ...
    def participants(self, request, _pk=None):
...
class MessageViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'])
    def react(self, request, _pk=None):
    ...
    @action(detail=True, methods=['get'])
    def thread(self, request, _pk=None):
...
class CollaborativeDocumentViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'])
    def lock(self, request, _pk=None):
    ...
    @action(detail=True, methods=['post'])
    def unlock(self, request, _pk=None):
        """Unlock a document."""
        document = self.get_object()
