...
from .models import (
    RevenueTarget, DealScore, Competitor, DealCompetitor, RevenueForecast, DealRiskAlert
)
from .serializers import (
    RevenueTargetSerializer, DealScoreSerializer, DealScoreSummarySerializer,
    CompetitorSerializer,
    DealCompetitorSerializer, RevenueForecastSerializer, DealRiskAlertSerializer
)
...
class CompetitorViewSet(viewsets.ModelViewSet):
    ...
    def battle_card(self, request, pk=None):
