...
from .serializers import (
    ...
    RescheduleMeetingSerializer,
    SchedulingPagePublicSerializer,
    SchedulingPageSerializer,
)
...
class SchedulingPageViewSet(viewsets.ModelViewSet):
    ...
    def stats(self, request, _pk=None):
        """Get page statistics"""
    ...
    def setup_default_availability(self, request, _pk=None):
...
class MeetingViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'])
    def reschedule(self, request, _pk=None):
    ...
    @action(detail=True, methods=['post'])
    def mark_completed(self, request, _pk=None):
    ...
    @action(detail=True, methods=['post'])
    def mark_no_show(self, request, _pk=None):
