...
from .models import (
    CustomerAccount, SuccessPlaybook, PlaybookExecution, RenewalOpportunity, ExpansionOpportunity, NPSSurvey, CustomerSuccessAnalytics
)
from .serializers import (
    CustomerAccountListSerializer, CustomerAccountDetailSerializer,
    HealthScoreSerializer, CustomerMilestoneSerializer, CustomerNoteSerializer,
    SuccessPlaybookSerializer, PlaybookStepSerializer, PlaybookExecutionSerializer,
    RenewalOpportunitySerializer, ExpansionOpportunitySerializer,
    NPSSurveySerializer, CustomerSuccessAnalyticsSerializer,
    SendNPSSerializer
)
...
class CustomerAccountViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['get'])
    def expansions(self, request, pk=None):
