...
class CallRecordingViewSet(viewsets.ModelViewSet):
    ...
    def reprocess(self, request, _pk=None):
    ...
    def transcript(self, request, _pk=None):
        """Get full transcript"""
        recording = self.get_object()
    ...
    @action(detail=True, methods=['get'])
    def analysis(self, request, _pk=None):
        """Get call analysis"""
        recording = self.get_object()
    ...
    @action(detail=True, methods=['get'])
    def topics(self, request, _pk=None):
        """Get topic mentions"""
        recording = self.get_object()
    ...
    @action(detail=True, methods=['post'])
    def add_coaching(self, request, _pk=None):
...
class CallPlaylistViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'])
    def add_clip(self, request, _pk=None):
...
class CallTrackerViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['get'])
    def mentions(self, request, _pk=None):
    ...
    @action(detail=True, methods=['get'])
    def trends(self, request, _pk=None):
