...
class WorkflowEngineService:
    ...
    def start_workflow(
        ...
        target_object: Optional[tuple] = None
    ) -> Dict[str, Any]:
    ...
    def _find_start_node(self, workflow):
        ...
        from .workflow_models import WorkflowNode, WorkflowConnection
    ...
    def _execute_node(self, instance, node):
        ...
        from .workflow_models import WorkflowNodeExecution, WorkflowLog
    ...
    def resume_workflow(self, instance_id: str, resume_data: Optional[Dict] = None):
...
class WorkflowDesignerService:
    ...
    def add_connection(
        ...
        from .workflow_models import WorkflowDefinition, WorkflowConnection
    ...
    def save_canvas(
        ...
        from .workflow_models import WorkflowDefinition, WorkflowNode, WorkflowConnection
    ...
    def clone_workflow(
        ...
        from .workflow_models import (
            ...
            WorkflowConnection, WorkflowVariable
        )
