...
class RecommendationEngine:
    ...
    def _generate_pipeline_health_recommendations(self):
        ...
        try:
            ...
            total_pipeline['total_value'] or 0
        ...
        try:
            ...
            for deal in deals_with_competition:
                self._create_recommendation(
                    ...
                    description="This deal mentions competitors or alternatives. Consider "
                               "preparing competitive battle cards and emphasizing your "
