...
class CustomField(models.Model):
    ...
    min_value = models.DecimalField(max_digits=20, decimal_places=2, blank=True)
    max_value = models.DecimalField(max_digits=20, decimal_places=2, blank=True)
...
class CustomFieldValue(models.Model):
    ...
    value_number = models.DecimalField(max_digits=20, decimal_places=2, blank=True)
    ...
    value_json = models.JSONField(blank=True)  # For multiselect, file info, etc.
