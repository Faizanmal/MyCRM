...
class AchievementService:
    ...
    def _award_achievement(self, user_id: str, achievement: Dict) -> Optional[Dict]:
...
class StreakService:
    ...
    def _get_streak(self, user_id: str, streak_type: str) -> Optional[Dict]:
...
class RewardService:
    ...
    def _get_reward(self, reward_id: str) -> Optional[Dict]:
