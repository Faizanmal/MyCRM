...
class ReportQueryBuilder:
    ...
    def _execute_flat(self, queryset) -> Dict[str, Any]:
        ...
        if column_names:
            queryset = queryset.values(*column_names)
        else:
    ...
    def _execute_grouped(self, queryset) -> Dict[str, Any]:
        ...
        for alias in aggregations.keys():
            columns.append({
                'name': alias,
...
class DashboardService:
    ...
    def add_widget(
        ...
        from .report_models import ReportDashboard, DashboardWidget, ReportWidget
    ...
    def get_dashboard_data(
        ...
        from .report_models import ReportDashboard, DashboardWidget
