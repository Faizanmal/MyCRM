...
from .tasks import calculate_kpi_task, execute_report_task
...
class DashboardViewSet(viewsets.ModelViewSet):
    ...
    def data(self, request, _pk=None):
...
class ReportViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'])
    def schedule(self, request, _pk=None):
    ...
    @action(detail=True, methods=['get'])
    def preview(self, request, _pk=None):
...
class KPIViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'])
    def calculate(self, request, _pk=None):
    ...
    @action(detail=True, methods=['get'])
    def history(self, request, _pk=None):
